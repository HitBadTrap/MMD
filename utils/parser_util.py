...
def add_model_options(parser):
    ...
    group.add_argument("--mlp_layers", default=1, type=int, help="Number of mlp layers.")
    group.add_argument("--if_bidirectional", action="store_true")
    group.add_argument("--if_channel", action="store_true")
    group.add_argument(
