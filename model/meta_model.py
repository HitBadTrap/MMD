...
from model.motion_unet import DiffMotionUNet
...
class MetaModel(nn.Module):
    def __init__(
        ...
        **kargs,
        ...
        self.mlp = self.arch(
            self.latent_dim, seq=kargs.get("input_motion_length"), mlp_layers=mlp_layers, 
            if_bidirectional=if_bidirectional, if_channel=if_channel
        )
